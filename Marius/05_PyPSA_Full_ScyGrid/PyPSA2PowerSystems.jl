...
println("=====START=====")
pypsa_bus = DataFrame(CSV.File("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Input_SciGrid_PyPSA_CSV/buses.csv"));
pypsa_gen_p_max = DataFrame(CSV.File("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Input_SciGrid_PyPSA_CSV/generators-p_max_pu.csv"));
pypsa_gen = DataFrame(CSV.File("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Input_SciGrid_PyPSA_CSV/generators.csv"));
pypsa_lines = DataFrame(CSV.File("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Input_SciGrid_PyPSA_CSV/lines.csv"));
pypsa_loads = DataFrame(CSV.File("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Input_SciGrid_PyPSA_CSV/loads.csv"));
pypsa_loads_p_set = DataFrame(CSV.File("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Input_SciGrid_PyPSA_CSV/loads-p_set.csv"));
...
CSV.write("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Output_SciGrid_PowerSystem_CSV/bus.csv",ps_bus)
CSV.write("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Output_SciGrid_PowerSystem_CSV/branch.csv",ps_branch)
CSV.write("PowerSystems.jl/Marius/05_PyPSA_Full_ScyGrid/Output_SciGrid_PowerSystem_CSV/gen.csv",ps_gen)
