...
# df_buses_p = DataFrame(CSV.File("01_PyPSA/Input/buses-p.csv"))
# anzahl_ts = size(df_buses_p)
...
for i in 1:size_lines[1]
    ...
    primary_shunt[i] = (c_nf_km*df_lines.length[i]*df_lines.num_parallel[i])*z_base*2*50*pi*1E-9
