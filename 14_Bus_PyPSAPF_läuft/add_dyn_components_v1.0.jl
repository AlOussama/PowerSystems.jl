...
function add_dyn_components(sys)
    ...
    for i in 1:size_gen
        ...
        if tech == "Gas"
            ...
            # avr_gen = IEEET1(
            #       # Quelle: https://scholarworks.uno.edu/cgi/viewcontent.cgi?article=3321&context=td
            #       # Seite 62
            #       # Quelle: https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.592.4354&rep=rep1&type=pdf
            #       # Seite: 110
            #     Tr = 0.00,
            #     Ka = 50,
            #     Ta = 0.02,
            #     Vr_lim = (min = -1.0, max= 1.0),
            #     Ke = 0.000,
            #     Te = 0.614,
            #     Kf = 0.098,
            #     Tf = 1.137,
        ...
        elseif tech == "Hard Coal"
            ...
            h_hardcoal = 4.2
            d_hardcoal = (2.0)/(3.148)*h_hardcoal
            R_hardcoal = 1.0
            Xd_p_hardcoal = 1.0
            eq_p_hardcoal = 1.0
            Vf_hardcoal = 1.0
        ...
        elseif tech == "Brown Coal"
            ...
            h_browncoal = 3.8
            d_browncoal = (2.0)/(3.148)*h_browncoal
            R_browncoal = 1.0
            Xd_p_browncoal = 1.0
            eq_p_browncoal = 1.0
            Vf_browncoal = 1.0
        ...
        elseif tech == "Multiple"
            stat_gen = get_component(ThermalStandard,sys,gen_name[i])
            h_multiple = 3.8
            d_multiple = (2.0)/(3.148)*h_multiple
            R_multiple = 1.0
            Xd_p_multiple = 1.0
            eq_p_multiple = 1.0
            Vf_multiple = 1.0
        ...
        elseif tech == "Geothermal"
            stat_gen = get_component(ThermalStandard,sys,gen_name[i])
            h_geothermal = 3.5
            d_geothermal = (2.0)/(3.148)*h_geothermal
            R_geothermal = 1.0
            Xd_p_geothermal = 1.0
            eq_p_geothermal = 1.0
            Vf_geothermal = 1.0
